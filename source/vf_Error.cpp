                    ...
                    Code errorCode)
{
  ...
  m_sourceFileName = getFileNameFromPath (sourceFileName);
...
Error& Error::fail (const char* sourceFileName,
                  ...
                  Code errorCode)
{
  return fail (sourceFileName, lineNumber, getReasonTextForCode (errorCode), errorCode);
}
...
const String Error::getFileNameFromPath (const char *sourceFileName)
{
  return String (boost::filesystem::path (sourceFileName).filename().c_str());
}

// Returns a String with double quotes escaped
static const String withEscapedQuotes (const String& string)
{
  String escaped;
...
static const String withUnescapedQuotes (const String& string)
{
  String unescaped;
...
String Error::stringToCommandLine (const String& string)
{
  String commandLine;
...
String Error::commandLineToString (const String& commandLine)
{
  String string;
