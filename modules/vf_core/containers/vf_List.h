...
/**
    ...
    typedef List <Object> ListType; // Linked list of Object
    ...
    // Declare our object as a ListType element

    class Object : public ListType::Node // must be public
    {
    public:
      void performAction ();
    };
    ...
    class Object : public List <Object>::Node
    {
      void performAction ();
    };
    ...
    because the book-keeping information for maintaining the list is kept in
